...
Avec cette version, nous avons également ajouté une [documentation de référence de l’API WinUI 3](/uwp/api/overview/winui/) pour toutes les API WinRT portées sur WinUI 3.
