 ...
 **App** | **Mac** | **Windows** |
|---------------|--------------------|---------------------|
| Settings and Preferences | System Preferences | Paramètres |
| Gestionnaire des tâches | Activity Monitor | Gestionnaire des tâches |
| Disk formatting | Disk Utility | Gestion des disques |
| Text editing | TextEdit | Bloc-notes |
| Event viewing | Console | Observateur d’événements |
| Find files/apps | Command+Space | touche Windows |
