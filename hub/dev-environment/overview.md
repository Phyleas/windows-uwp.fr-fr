...
:::row:::
    ...
    :::column-end:::
    :::column:::
       [![Bureau Windows](../images/windows-logo.png)](../apps/index.yml)<br>
...
:::row:::
    ...
    :::column-end:::
    :::column:::
       [![Azure pour Java](../images/java-logo.png)](/azure/developer/java/)<br>
...
:::row:::
    ...
    :::column-end:::
    :::column:::
       [![Gestionnaire de package Windows](../images/winget.png)](../package-manager/index.md)<br>
...
- Pour en savoir plus, consultez la [documentation sur le Terminal Windows](/windows/terminal) ou des [vidéos sur le Terminal Windows sur Channel 9](https://channel9.msdn.com/Search?term=windows%20terminal&lang-en=true).
...
* [Terminal et outils shell](./mac-to-windows.md#terminal-and-shell)
