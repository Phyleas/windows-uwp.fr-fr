...
ms.date: 02/08/2017
ms.topic: article
keywords: Windows 10, UWP, jeux, DirectX, 2D, graphiques
...
-   [Vue d’ensemble de Direct2D](/windows/desktop/Direct2D/direct2d-overview)
-   [Démarrage rapide de Direct2D](/windows/desktop/Direct2D/getting-started-with-direct2d)
-   [Vue d’ensemble de l’interopérabilité de Direct2D et Direct3D](/windows/desktop/Direct2D/direct2d-and-direct3d-interoperation-overview)