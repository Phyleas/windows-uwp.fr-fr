...
Si vous débutez en programmation asynchrone, consultez [opérations simultanées et asynchrones avec C++/WinRT](/windows/uwp/cpp-and-winrt-apis/concurrency).
