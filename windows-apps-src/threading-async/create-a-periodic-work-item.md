...
description: Découvrez comment créer un élément de travail qui se répète régulièrement à l’aide de la méthode CreatePeriodicTimer de l’API ThreadPoolTimer plateforme Windows universelle (UWP).
ms.date: 02/08/2017
ms.topic: article
