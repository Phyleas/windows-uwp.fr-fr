...
|---------------|--------|---------------|------|
| applicationId | string | [ID de stockage](in-app-purchases-and-trials.md#store-ids) de l’application pour laquelle vous souhaitez récupérer les données de conversion de module complémentaire. Exemple d’ID Windows Store : 9WZDNCRFJ3Q8. |  Oui  |
| inAppProductId | string | [ID de stockage](in-app-purchases-and-trials.md#store-ids) du module complémentaire pour lequel vous souhaitez récupérer les données de conversion.  | Oui  |
...
|------------|--------|-------------------------------------------------------|
| Valeur      | tableau  | Tableau d’objets qui contient les données de conversion d’agrégation pour le module complémentaire. Pour plus d’informations sur les données de chaque objet, consultez la section [conversion des valeurs](#conversion-values) ci-dessous.                     |
...
| inAppProductId      | string  | [ID de stockage](in-app-purchases-and-trials.md#store-ids) du module complémentaire pour lequel vous extrayez des données de conversion.     |
| inAppProductName    | string  | Nom complet du module complémentaire pour lequel vous récupérez les données de conversion.   |
...
| appType          | string |  Type du produit pour lequel vous extrayez des données de conversion. Pour cette méthode, la seule valeur prise en charge est **module complémentaire**.            |
