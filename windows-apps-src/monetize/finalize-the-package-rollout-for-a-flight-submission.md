---
description: Utilisez cette méthode dans l’API de soumission Microsoft Store pour finaliser le déploiement du package pour une soumission de vol de package.
title: Finaliser le lancement d’une soumission de version d’évaluation de package
ms.date: 04/17/2018
ms.topic: article
keywords: Windows 10, UWP, Microsoft Store API de soumission, déploiement de packages, soumission de vol, finaliser
...
ms.locfileid: "89171524"
---
# <a name="finalize-the-rollout-for-a-flight-submission"></a>Finaliser le lancement d’une soumission de version d’évaluation de package


Utilisez cette méthode dans l’API de soumission Microsoft Store pour [finaliser le déploiement du package](../publish/gradual-package-rollout.md#completing-the-rollout) pour une soumission de vol de package. Pour plus d’informations sur le processus de création d’une soumission de vol de packages à l’aide de l’API de soumission Microsoft Store, consultez [gérer les envois de vols de packages](manage-flight-submissions.md).
...
* Créer une soumission pour une application dans l’espace partenaires. Vous pouvez effectuer cette opération dans l’espace partenaires, ou vous pouvez le faire à l’aide de la méthode [créer une soumission d’application](create-an-app-submission.md) .
...
|---------------|--------|-----------------------------------------------------------------------------|
| applicationId | string | Obligatoire. ID Windows Store de l’application qui contient la soumission de version d’évaluation du package avec le lancement du package que vous voulez finaliser. Pour plus d’informations sur l’ID Windows Store, voir [Visualiser les informations d’identité des applications](../publish/view-app-identity-details.md).  |
