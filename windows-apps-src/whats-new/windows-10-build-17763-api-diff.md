...
#### <a name="clipboard"></a>[Presse-papiers](/uwp/api/windows.applicationmodel.datatransfer.clipboard)
...
#### <a name="control"></a>[Contrôler](/uwp/api/windows.ui.xaml.controls.control)
