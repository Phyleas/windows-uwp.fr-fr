...
> [!NOTE]
> Pour un exemple complet, consultez l'[Exemple d'énumération de dossier](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/FolderEnumeration).
