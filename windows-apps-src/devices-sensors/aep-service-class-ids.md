...
Pour obtenir une liste plus complète des services Bluetooth disponibles, consultez la [spécification services GATT](https://www.bluetooth.com/specifications/gatt/services/). Vous pouvez également utiliser l’API [**GattServiceUuids**](/uwp/api/Windows.Devices.Bluetooth.GenericAttributeProfile.GattServiceUuids) pour accéder à des services GATT courants.
