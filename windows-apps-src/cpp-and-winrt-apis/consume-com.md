...
Vous pouvez appeler la fonction libre [**winrt::get_unknown**](/uwp/cpp-ref-for-winrt/get-unknown) pour passer votre **com_ptr** à une fonction qui accepte un pointeur d’interface **IUnknown**.
