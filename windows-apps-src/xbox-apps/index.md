...
|[Fonctionnalités UWP qui ne sont pas encore prises en charge sur Xbox One](https://docs.microsoft.com/uwp/extension-sdks/uwp-limitations-on-xbox?redirectedfrom=MSDN)|  Décrit les fonctionnalités UWP qui ne sont pas encore entièrement opérationnelles sur Xbox One.|
