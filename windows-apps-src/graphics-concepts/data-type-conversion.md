...
-   Une représentation INF dans un format de plage inférieure est convertie en représentation INF dans le format de plage supérieure si cette représentation est disponible. Si le format supérieur n’a pas de représentation INF, il sera converti en valeur maximale pouvant être représentée (MAX\_FLOAT dans ce format). Le signe est conservé s’il est disponible dans le format cible.
