...
Lorsque vous sélectionnez **Résultat : destinataire par e-mail** dans la boîte de dialogue Exporter la chaîne, l'e-mail comprend un lien de téléchargement et d'installation du kit de ressources Multilingual App Toolkit (MAT) 4.0. Votre traducteur est toujours en mesure d'installer l'outil MAT 4.0 autonome Multilingual Editor, même sans Windows 10 ou Visual Studio.
...
* [Utiliser la boîte à outils de l’application multilingue 4,0](use-mat.md)
* [Microsoft Translator](https://www.microsofttranslator.com/)
