...
- Spécifiez une sous-balise de script de langue dans le qualificateur quand aucune valeur de Suppress-Script n’est définie pour la langue. Par exemple, au lieu de zh-CN ou zh-TW, utilisez zh-Hant, zh-Hant-TW ou zh-Hans (pour plus de détails, consultez le registre de la sous- [balise de langue IANA](https://www.iana.org/assignments/language-subtag-registry)).
