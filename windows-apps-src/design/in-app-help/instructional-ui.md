---
description: Concevoir une interface utilisateur pédagogique qui apprend aux utilisateurs comment travailler avec votre application Windows.
...
Une interface utilisateur d’instructions allie pertinence et pédagogie, et améliore l’expérience utilisateur. Ce doit être :

-   **Simple :** Les utilisateurs ne veulent pas que leur expérience soit interrompue avec des informations compliquées
...
Évitez de déranger l’utilisateur avec votre interface utilisateur d’instructions. Ne pas :
