...
> **API importantes** : [Grid (classe)](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.grid), [StackPanel (classe)](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.stackpanel)
