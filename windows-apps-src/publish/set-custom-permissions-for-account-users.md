...
> [!TIP]
> Cette rubrique est spécifique au programme développeur d’applications Windows dans l' [espace partenaires](https://partner.microsoft.com/dashboard). Pour plus d’informations sur les rôles d’utilisateur dans le programme de développement matériel, consultez [gestion des rôles d’utilisateur](https://docs.microsoft.com/windows-hardware/drivers/dashboard/managing-user-roles). Pour plus d’informations sur les rôles d’utilisateur dans le programme d’application de bureau Windows, consultez [Windows Desktop Application Program](https://docs.microsoft.com/windows/desktop/appxpkg/windows-desktop-application-program#add-and-manage-account-users).
