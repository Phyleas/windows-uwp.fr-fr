...
|--------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|
| earningId                      | Identificateur unique pour chaque gain                                                                                                       | Toutes                                                            |
| participantId                  | Identité principale du partenaire qui accumule le programme                                                                            | Toutes                                                            |
| participantIdType              | Principalement l’ID de programme pour les programmes d’incentives et le vendeur si pour les programmes Store et la place de marché Azure                                          | Toutes                                                            |
| participantName                | Nom du partenaire gagnant                                                                                                              | Toutes                                                            |
| partnerCountryCode             | Emplacement/pays du partenaire gagnant                                                                                                  | Toutes                                                            |
| nom_programme                    | Nom du programme d’incentives/boutiques                                                                                                             | Toutes                                                            |
...
| transactionDate                | Date de la transaction. Utile pour les programmes où de nombreuses transactions contribuent à un gain                                           | Toutes                                                            |
| transactionExchangeRate        | Date du taux de change utilisée pour afficher la transaction correspondante en euros                                                                 | Toutes                                                            |
| transactionAmount              | Montant de la transaction dans la devise de transaction d’origine en fonction de la quantité de données générées                                              | Toutes                                                            |
| transactionAmountUSD           | Montant de la transaction en USD                                                                                                                | Toutes                                                            |
| situés                          | Indique une règle d’entreprise pour le bénéfice                                                                                                  | Toutes                                                            |
| earningRate                    | Taux d’incentives appliqué au montant de la transaction pour générer un gain                                                                      | Toutes                                                            |
...
| earningAmount                  | Montant de l’obtention dans la devise de la transaction d’origine                                                                                      | Toutes                                                            |
| earningAmountUSD               | Montant de gain en USD                                                                                                                    | Toutes                                                            |
| earningDate                    | Date du gain                                                                                                                      | Toutes                                                            |
| calculationDate                | Date à laquelle l’obtention a été calculée dans le système                                                                                            | Toutes                                                            |
| earningExchangeRate            | Taux de change utilisé pour afficher la quantité USD correspondante                                                                                  | Toutes                                                            |
| exchangeRateDate               | Date du taux de change utilisée pour calculer EarningAmount USD                                                                                   | Toutes                                                            |
| paymentAmountWOTax             | Gain de montant (sans taxe) dans le paiement de la devise pour les paiements « envoyés » uniquement                                                                 | Toutes                                                            |
| paymentCurrency                | Paiement à la devise choisie par le partenaire dans le profil de paiement. Affiché uniquement pour les paiements envoyés                                                   | Toutes                                                            |
| paymentExchangeRate            | Taux de change utilisé pour calculer paymentAmountWOTax dans la devise de paiement à l’aide de ExchangeRateDate                                            | Toutes                                                            |
