...
| **Prix de base**                | Requis                                    | [Définir et planifier la tarification des applications](set-and-schedule-app-pricing.md)              |
| **Évaluation gratuite**                | Par défaut : aucune version d'essai gratuit                      | [Évaluation gratuite](set-app-pricing-and-availability.md#free-trial)              |
| **Vente à prix réduit**              | Facultatif                                    | [Commercialiser des applications et composants additionnels](put-apps-and-add-ons-on-sale.md)           |
...
| Nom du champ                    | Notes                                       | Informations supplémentaires                                                             |
|-------------------------------|---------------------------------------------|---------------------------------------------------------------------------|
| **Catégorie et sous-catégorie**  | Requis                                    | [Table de catégorie et de sous-catégorie](category-and-subcategory-table.md)       |
...
| Nom du champ                    | Notes                                       | Informations supplémentaires                          |
|-------------------------------|---------------------------------------------|----------------------------------------|
| **Évaluations de l’âge**               | Requis                                    | [Évaluations de l’âge](age-ratings.md)          |
...
| Nom du champ                    | Notes                                       | Informations supplémentaires                                                     |
|-------------------------------|---------------------------------------------|-------------------------------------------------------------------|
| **Description**               | Requis                                    | [Écrire une description d’application intéressante](write-a-great-app-description.md) |
...
| **Image Windows 10 et Xbox (16:9 super héros art)**     | Nos recommandations        | [Image Windows 10 et Xbox (16:9 super héros art)](app-screenshots-and-images.md#windows-10-and-xbox-image-169-super-hero-art) |
...
| **Notes pour la certification**     | Nos recommandations          | [Notes pour la certification](notes-for-certification.md)             |
