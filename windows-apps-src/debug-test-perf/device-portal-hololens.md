...
2. Recherchez l’adresse IP de votre appareil. Recherchez l’adresse IP sur l’appareil sous **paramètres > réseau & Internet > les propriétés du matériel > Wi-Fi**. Vous pouvez également demander : « Hey Cortana, quelle est mon adresse IP ? »
...
2. Téléchargez le certificat de cet appareil à partir de la page « sécurité » sur le portail de l’appareil. cliquez sur le lien sécurité dans la liste des icônes en haut à droite ou accédez à : `https://<YOUR_HOLOLENS_IP_ADDRESS>/devicesecurity.htm`
