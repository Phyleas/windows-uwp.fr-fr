...
title: Performances
description: Découvrez comment organiser votre flux de travail de performances, corriger les problèmes d’animation et de fréquence d’images, et régler le temps de démarrage, la durée de navigation par page et l’utilisation de la mémoire.
ms.date: 02/08/2017
ms.topic: article
...
Si vous ne l’avez pas encore fait, nous vous conseillons de porter votre application vers Windows 10 ; vous devriez constater une amélioration significative des performances. Plusieurs optimisations XAML (par exemple, [{x:Bind}](../xaml-platform/x-bind-markup-extension.md)) sont uniquement disponibles dans les applications Windows 10. Consultez [Portage d’applications vers Windows 10](../porting/index.md) et la session //build/ [Moving to the Universal Windows Platform](https://channel9.msdn.com/Events/Build/2015/3-741).
...
| [Optimisation des options d’interface ListView et GridView](optimize-gridview-and-listview.md) | Améliorez les performances du contrôle [<strong>GridView</strong>](/uwp/api/Windows.UI.Xaml.Controls.GridView) et le temps de démarrage à travers la virtualisation de l’interface utilisateur, la réduction des éléments et la mise à jour progressive des éléments. |
| [Virtualisation des données ListView et GridView](listview-and-gridview-data-optimization.md) | Améliorez les performances du contrôle [<strong>GridView</strong>](/uwp/api/Windows.UI.Xaml.Controls.GridView) et le temps de démarrage avec la virtualisation des données. |
