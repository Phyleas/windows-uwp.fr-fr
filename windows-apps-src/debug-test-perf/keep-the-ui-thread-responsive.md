...
Les files d'attente [**CoreDispatcher.RunIdleAsync**](https://docs.microsoft.com/uwp/api/windows.ui.core.coredispatcher.runidleasync) fonctionnent pour le traitement par le thread d'interface utilisateur lorsque ce dernier n'est pas occupé.
...
> **Remarque**  Il existe également pour UWP des API [**ThreadPool**](https://docs.microsoft.com/uwp/api/Windows.System.Threading.ThreadPool) et [**ThreadPoolTimer**](https://docs.microsoft.com/uwp/api/windows.system.threading.threadpooltimer) qui peuvent être utilisées dans des scénarios similaires. Pour plus d’informations, voir [Threads et programmation asynchrone](https://docs.microsoft.com/windows/uwp/threading-async/index).
