...
> **Notez**  la seule exception est qu’il existe un thread de rendu distinct qui peut appliquer des modifications de l’interface utilisateur qui n’affecteront pas la manière dont l’entrée est gérée ou la disposition de base. Par exemple, de nombreuses animations et transitions qui n’affectent pas la disposition peuvent être exécutées sur ce thread de rendu.
