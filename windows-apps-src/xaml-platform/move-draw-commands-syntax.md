...
| Terme | Description |
|------|-------------|
| _startPoint_ | [**Point**](/uwp/api/Windows.Foundation.Point) <br/>Le point de départ d’une nouvelle figure.|
...
| Terme | Description |
|------|-------------|
| x | [**Cliquer**](/dotnet/api/system.double) <br/> La coordonnée x du point de fin de la ligne. |
...
| Terme | Description |
|------|-------------|
| *y* | [**Cliquer**](/dotnet/api/system.double) <br/> La coordonnée y du point de fin de la ligne. |
...
| Terme | Description |
|------|-------------|
| *size* | [**Size**](/uwp/api/Windows.Foundation.Size)<br/>Rayon x et rayon y de l’arc. |
| *rotationAngle* | [**Cliquer**](/dotnet/api/system.double) <br/> La rotation de l’ellipse, en degrés. |
...
| Terme | Description |
|------|-------------|
| *x* | [**Cliquer**](/dotnet/api/system.double) <br/> Coordonnée X du point. |
| *y* | [**Cliquer**](/dotnet/api/system.double) <br/> Coordonnée Y du point. |
