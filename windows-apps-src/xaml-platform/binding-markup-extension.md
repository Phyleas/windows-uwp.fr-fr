...
| *propName* | Nom de chaîne de la propriété à définir sur l’objet [**Binding**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Data.Binding). Par exemple, « Converter ». |
