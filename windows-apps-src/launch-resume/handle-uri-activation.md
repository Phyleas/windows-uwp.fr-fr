...
| **Nom complet** | Spécifiez le nom d’affichage pour identifier le nom de schéma d’URI dans [Définir les programmes par défaut](https://docs.microsoft.com/windows/desktop/shell/default-programs) du **Panneau de configuration**. |
...
- [Modèle d’association de type de fichier et d’URI](https://docs.microsoft.com/windows/desktop/w8cookbook/file-type-and-protocol-associations-model)
