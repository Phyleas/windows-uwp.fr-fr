...
Dans cet exemple, la classe [**LauncherOptions**](https://docs.microsoft.com/uwp/api/Windows.System.LauncherOptions) est utilisée pour garantir que l’application Windows Maps est lancée.
