...
-   [Exemples d’applications UWP utilisant DirectX](https://code.msdn.microsoft.com/windowsapps/site/search?f%5B0%5D.Type=Technology&f%5B0%5D.Value=DirectX)
-   [Où se trouve le kit de développement logiciel (SDK) DirectX ?](https://docs.microsoft.com/windows/desktop/directx-sdk--august-2009-)
...
-   [Créer votre première application UWP à C# l’aide de ou Visual Basic](../get-started/create-a-hello-world-app-xaml-universal.md)
-   [Exemples d’applications UWP utilisantC#](https://code.msdn.microsoft.com/windowsapps/site/search?f%5B0%5D.Type=ProgrammingLanguage&f%5B0%5D.Value=C%23&f%5B0%5D.Text=C%23)
...
[Mise en route : se familiariser avec Visual Studio](getting-started-getting-around-in-visual-studio.md)
