...
<td align="left">La classe <strong>CLLocationManager</strong> <strong>emplacement principal</strong> est utilisée pour surveiller l’emplacement d’un appareil, avec <strong>startUpdatingLocation</strong> pour le service d’emplacement standard et <strong>startMonitoringSignificantLocationChanges</strong> pour le service de localisation de <strong>changement significatif</strong> .</td>
